...
void		ft_handler_f_float(t_printf *my_printf, va_list printf_list)
{
	...
	/*if (my_printf->h == 1)
		...
		ft_print_f_float(my_printf, va_arg(printf_list, unsigned long));
	else if (my_printf->l == 2)
		ft_print_f_float(my_printf,
				va_arg(printf_list, unsigned long long));
	else if (my_printf->j == 1)
		ft_print_f_float(my_printf, va_arg(printf_list, uintmax_t));
	else if (my_printf->z == 1)
		ft_print_f_float(my_printf, va_arg(printf_list, size_t));
	else
		ft_print_f_float(my_printf, va_arg(printf_list, unsigned int));*/
}
